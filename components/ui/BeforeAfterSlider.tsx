...
export default function BeforeAfterSlider() {
    ...
    return (
        <section className="flex flex-col items-center justify-center h-auto  px- py-10  ">
            {/* Heading */}
            <div className="mb-6 sm:mb-8 text-center">
                ...
                <h2
                    className="text-xl sm:text-3xl md:text-4xl gont-heading font-light text-white leading-tight"
            ...
            >
                ...
                {/* AFTER image (clipped to left side via clip-path) */}
                <div
                ...
                {/* Drag handle */}
                <div
                    className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-white shadow-xl border border-white/30 z-10 transition-transform duration-75"
