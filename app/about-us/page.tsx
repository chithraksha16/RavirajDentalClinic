    ...
    return (
        <section>
            ...
            <div className="w-full h-130 bg-black pt-10">
                <h1 className="text-center font-heading font-medium sm:text-[40px] text-[30px] text-white pt-15 flex flex-col">
                    <span className="text-[#072959]">About</span> Our Dental Care
                </h1>
                <p className="font-heading sm:text-[14px] text-[12px] text-center text-[#8D9EB7]">
                    Dedicated to providing trusted dental care for a healthy, confident smile.
                </p>
                <div className="flex items-center flex-col gap-5 justify-center mt-18">
                    <p className="font-heading sm:text-[14px] text-[12px] sm:w-175 w-auto px-2 sm:px-0 text-center text-[#8D9EB7]">
                        At our clinic, we deliver high-quality dental care with an emphasis on comfort, hygiene, and long-term results. Our experienced team is committed to helping you achieve a healthy, confident smile.
                    </p>
                    <Link href="https://www.dentee.com/clinic/udupi/raviraj-dental-clinic/3e115265-aaea-4469-a93a-8f3d0160f242" target="_blank">
                        <Button className="bg-[#072959] text text-white flex gap-1" size="sm">
            ...
            {/* Team Section */}
            <div className="w-full bg-[#E2E8F0] sm:px-10 px-4 sm:py-10 py-8">
                <div className="py-10 space-y-1">
                ...
                {teamGroups.map((group) => (
                    <div key={group.label} className="mb-6">
                        ...
                        <div className="flex items-center gap-4 my-8 sm:my-10">
                            <div className="flex-1 h-px bg-[#b0bec8]" />
                            <span className="text-[11px] font-bold tracking-[0.18em] text-[#072959] uppercase shrink-0 px-2">
                                {group.label}
                            </span>
                            <div className="flex-1 h-px bg-[#b0bec8]" />
                        </div>

                        {/* Single member (Chief) — centered */}
                        {group.members.length === 1 ? (
                            <div className="flex justify-center">
                                <div className="w-[288px] shrink-0 flex flex-col bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100">
                                    <div className="w-full" style={{ aspectRatio: "3/4" }}>
                                        <Image
                                            src={group.members[0].photo}
                                    ...
                                    <div className="flex flex-col items-center text-center gap-1 px-4 py-5">
                                        <h3 className="font-heading font-semibold text-[20px] text-[#1a1a1a] leading-snug">
                                            {group.members[0].name}
                                        </h3>
                                        <h4 className="font-body text-[13px] font-medium text-[#2563eb] mb-2">
                                            {group.members[0].speciality}
                                        </h4>
                                        <p className="font-body text-[12px] text-[#4C4B48] leading-relaxed">
                            ...
                            <div className="flex flex-wrap justify-center gap-5 max-w-[904px] mx-auto">
                                {group.members.map((member) => (
                                    <div
                                        key={member.id}
                                        className="w-[288px] shrink-0 flex flex-col bg-white rounded-2xl overflow-hidden shadow-md border border-gray-100"
                                    >
                                        <div className="w-full" style={{ aspectRatio: "3/4" }}>
                                            <Image
                                                src={member.photo || ""}
                ...
                {/* Full Team Photo */}
                <div className="pt-16 pb-10 space-y-4">
